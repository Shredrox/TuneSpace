...
public interface IDataEnrichmentService
{
    ...
    Task<List<BandModel>> EnrichMultipleBands(List<BandModel> bands);
    ...
    Task<BandModel?> GetCachedBandData(string bandName);
    ...
    Task<Dictionary<string, List<BandModel>>> GetSimilarBandsForMultipleArtists(
